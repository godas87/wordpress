...
<div class="row align-center pb-4">
  <div class="col s-12 m-10 l-12">

    <h2 class="faq-section-title bold">
      <?php _e('Perguntas relacionadas', 'bazar'); ?>
    </h2>

    <p class="faq-section-subtitle">
      <?php _e('Separamos algumas dúvidas comuns', 'bazar'); ?>
    </p>
    ...
    if (
      ...
      ?>
      <ul id="faq-toogle" class="faq faq-blog grid-1">
        <?php
        $items = [];
        foreach ($faq as $item):
          $items[] = $item;
